...
class GleanGenerator(nn.Module):
    def __init__(self,
        ...
        self.dec_torgb = ToRGBLayer(channels_dict[max(self.dec_attachment_resolutions)], img_channels, w_dim=w_dim,
    ...
    # Performs style mixing only within the decoder region of the GLEAN generator (resulting in 3 separate styles)
...
def convert_stylegan2_pickle(pkl, enc_input_resolution):
    ...
    G = dnnlib.util.construct_class_by_name(class_name='training.glean_networks.GleanGenerator',
